...
>
> Detta repository innehåller över 50 språkversioner vilket betydligt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparsamt utsnitt:
>
> **Bash / macOS / Linux:**
> ```bash
...
Om det är första gången du bygger med generativa AI-modeller, kolla in vår kurs [Generative AI For Beginners](https://aka.ms/genai-beginners), som inkluderar 21 lektioner om att bygga med GenAI.
...
Varje lektion i denna kurs innehåller kodexempel, vilka finns i mappen code_samples. Du kan [fork detta repo](https://github.com/microsoft/ai-agents-for-beginners/fork) för att skapa din egen kopia.
...
Har du förslag eller har hittat stavnings- eller kodfel? [Rapportera ett ärende](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [Skapa en pull-begäran](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Pythonkodexempel med Microsoft Agent Framework och Azure AI Foundry
...
| Tool Use Design Pattern                     | [Länk](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Länk](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bygga Värdiga AI-agenter                   | [Länk](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Länk](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Multi-Agent Design Pattern                  | [Länk](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Länk](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Bygga datoranvändaragenter (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Contributor License Agreement (CLA) där du intygar att du har rätt att ge oss
rättigheterna att använda ditt bidrag. För mer information, besök <https://cla.opensource.microsoft.com>.

När du skickar en pull-begäran kommer en CLA-bot automatiskt avgöra om du behöver tillhandahålla
en CLA och markera PR korrekt (t.ex. statuskontroll, kommentar). Följ helt enkelt instruktionerna
från boten. Du behöver bara göra detta en gång för alla repo som använder vår CLA.

Det här projektet har antagit [Microsofts Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
