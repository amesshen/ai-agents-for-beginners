...
## Курс, който ви учи на всичко необходимо, за да започнете да изграждате AI агенти
...
Този курс съдържа уроци, покриващи основите на изграждане на AI агенти. Всеки урок разглежда своята тема, така че започнете откъдето искате!

Този курс поддържа много езици. Посетете [наличните езици тук](#-multi-language-support).

Ако е първият път, когато изграждате с генеративни AI модели, разгледайте нашия курс [Generative AI For Beginners](https://aka.ms/genai-beginners), който включва 21 урока за работа с GenAI.

Не забравяйте да [звездичкате (🌟) това репо](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и да [форкнете това репо](https://github.com/microsoft/ai-agents-for-beginners/fork), за да стартирате кода.

### Срещнете други ученици, задайте въпросите си
...
Всеки урок в този курс включва кодови примери, които може да намерите в папката code_samples. Можете да [форкнете това репо](https://github.com/microsoft/ai-agents-for-beginners/fork), за да създадете своето копие.
...
За повече информация относно стартирането на кода за този курс, разгледайте [Course Setup](./00-course-setup/README.md).
...
| Модел за употреба на инструменти              | [Връзка](./04-tool-use/README.md)                    | [Видео](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Връзка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)     |
...
| Изграждане на доверени AI агенти              | [Връзка](./06-building-trustworthy-agents/README.md) | [Видео](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Връзка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)     |
...
| Модел за многоагентна система                 | [Връзка](./08-multi-agent/README.md)                 | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Връзка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)     |
...
| AI агенти в производство                      | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Споразумение за лицензиране на сътрудници (CLA), което декларира, че имате право и фактически предоставяте
...
посочени от бота. Ще трябва да го направите само веднъж във всички хранилища, използващи нашия CLA.
...
Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Разрешената употреба на търговските
марки или лога на Microsoft е предмет на и трябва да следва
[Правила за търговски марки и бранд на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Използването на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да създава объркване или да предполага спонсорство от страна на Microsoft.
...
Ако имате обратна връзка или грешки при разработване, посетете:
