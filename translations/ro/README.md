...
## Un curs care vă învață tot ce trebuie să știți pentru a începe să construiți Agenți AI
...
[![Cereri Pull GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
**Dacă dorești să fie susținute limbi adiționale de traducere, listate sunt [aici](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Dacă este prima dată când construiești cu modele Generative AI, verifică cursul nostru [Generative AI pentru Începători](https://aka.ms/genai-beginners), care include 21 de lecții despre construirea cu GenAI.

Nu uita să [adaugi această repo la favorite (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) și să [faci fork acestui depozit](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a rula codul.

### Întâlnește alți cursanți, obține răspunsuri la întrebări

Dacă te blochezi sau ai întrebări despre construirea Agenților AI, alătură-te canalului nostru Discord dedicat din [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ce ai nevoie

Fiecare lecție din acest curs include exemple de cod care pot fi găsite în folderul code_samples. Poți [face fork la acest depozit](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a-ți crea propria copie.
...
Acest curs folosește următoarele framework-uri și servicii de Agenți AI de la Microsoft:
...
Ai sugestii sau ai găsit erori de scriere ori de cod? [Deschide o problemă](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [crează o cerere pull](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Legături către resurse suplimentare pentru a vă continua învățarea


## 🗃️ Lecții

| **Lecția**                                   | **Text & Cod**                                     | **Video**                                                  | **Învățare suplimentară**                                                            |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Intro la Agenții AI și Cazuri de Utilizare   | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Mulțumim lui [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pentru contribuirea de exemple importante de cod care demonstrează Agentic RAG.

## Contribuții

Acest proiect primește cu plăcere contribuții și sugestii. Cele mai multe contribuții necesită să fiți de acord cu un
Acord de Licență pentru Contribuitor (CLA) declarând că aveți dreptul și într-adevăr acordați
drepturile noastre de a folosi contribuția dumneavoastră. Pentru detalii, vizitați <https://cla.opensource.microsoft.com>.

Când trimiteți o cerere de extragere, un bot CLA va determina automat dacă trebuie să furnizați
un CLA și va decora PR-ul corespunzător (de exemplu, verificare de stare, comentariu). Pur și simplu urmați instrucțiunile
...
[Ghidurile Microsoft privind Mărcile Comerciale și Brandurile](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Orice utilizare a mărcilor comerciale sau logo-urilor unor terțe părți este supusă politicilor acelorași terți.
