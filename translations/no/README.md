...
>
> Dette depotet inkluderer oversettelser til 50+ språk som øker nedlastingsstørrelsen betydelig. For å klone uten oversettelser, bruk sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Hvis du ønsker ekstra støttede oversettelsesspråk er listet [her](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Dette kurset har leksjoner som dekker det grunnleggende om bygging av AI-agenter. Hver leksjon dekker sitt eget tema så start der du vil!

Det finnes flerspråklig støtte for dette kurset. Gå til våre [tilgjengelige språk her](#-multi-language-support).

Hvis dette er din første gang du bygger med generative AI-modeller, sjekk ut vårt kurs [Generative AI For Beginners](https://aka.ms/genai-beginners) som inkluderer 21 leksjoner om bygging med GenAI.
...
Hvis du sitter fast eller har spørsmål om bygging av AI-agenter, bli med i vår dedikerte Discord-kanal i [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Når du sender en forespørsel om sammenslåing, vil en CLA-bot automatisk avgjøre om du må
oppgi en CLA og merke PR på riktig måte (f.eks. statuskontroll, kommentar). Følg bare instruksjonene
fra boten. Du må bare gjøre dette én gang på tvers av alle repos som bruker vår CLA.
...
Bruk av Microsofts varemerker eller logoer i modifiserte versjoner av dette prosjektet må ikke skape forvirring eller antyde Microsoft-sponsorat.
Enhver bruk av tredjeparts varemerker eller logoer er underlagt disse tredjeparts retningslinjer.
...
Hvis du har produktanmeldelser eller feil mens du bygger, besøk:
